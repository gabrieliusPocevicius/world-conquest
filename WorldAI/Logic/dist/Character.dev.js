...
var Character = function Character(agePassed, gender) {
  ...
  if (percent <= 50) {
    ...
    var livingSpace = document.getElementById("space_".concat(man.id));
