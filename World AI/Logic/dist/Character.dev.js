...
var Character = function Character() {
  ...
  if (percent <= 60) {
    ...
    this.armour = 0;
    this.age = (0, _DataBase.log)("age" + setInterval(function () {
      return _Time.age;
    }, 1000));
    this.risk = 0;
    ++male;
