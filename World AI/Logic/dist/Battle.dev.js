...
openPersonDataCard(); //arrows to move ect...

var counter = 0;
$("#battleScene").hide();
$("#start-battle-btn").on("click", function () {
  counter++;
  console.log(counter);
...
stopKeysUpDown(); //no battle at the moment.
...
var left_flank_men = 500;
$("#unit001").on("click", function () {
...
function displayUpdatedArmy() {
  function updateArmy() {
    ...
    for (var i = 0; i < _Character.people.count; i++) {
